...
num_words <- sapply(strsplit(zacatrus_data$Nombre, " "), length)

zacatrus_data <- transform(zacatrus_data, Nombre= ifelse(stri_length(word(Nombre,1))>3, 
                                                         word(Nombre,1), 
                                                         ifelse(num_words > 1 && stri_length(word(Nombre,2))>3, 
                                                                word(Nombre,2), 
                                                                ifelse(num_words > 2 && stri_length(word(Nombre,3))>3,
                                                                       word(Nombre,3),
                                                                       Nombre))))
...
zacatrus_data <- select(zacatrus_data,-Medidas)
...
count(zacatrus_data, is.na(zacatrus_data$Nombre))
```
